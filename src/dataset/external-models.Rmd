...
This tutorial shows how to use Claude Code with non-Anthropic models like OpenAI, Gemini, and other LMLM providers through LiteLLM proxy.
...
and select any LiteLLM-managed model (`gpt-5.6-terra`, `gemini-3.8-flash`, `anthropic-vertex`, etc.) to switch without restarting the session.
